...
class Main {
    public static void solve(String testcase) throws IOException {
        ...
        for (int i = 0; i < Integer.parseInt(arrayStr[1]); i++) {
            ...
            int basket1 = Integer.parseInt(inputStr[0]) - 1;
            int basket2 = Integer.parseInt(inputStr[1]) - 1;
            int temp = 0;

            temp = arrayNum[basket1];
            arrayNum[basket1] = arrayNum[basket2];
            arrayNum[basket2] = temp;
